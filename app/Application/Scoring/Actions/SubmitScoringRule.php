...
final class SubmitScoringRule {
    public function __construct(private readonly ScoringRuleLifecycleService $service) {}
    public function handle(ScoringRule $rule, User $actor, Request $request): ScoringRule { return $this->service->submit($rule, $actor, $request); }
}
