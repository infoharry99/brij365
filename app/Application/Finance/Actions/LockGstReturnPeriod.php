...
final class LockGstReturnPeriod
{
    public function __construct(private readonly GstComplianceService $gst) {}
    public function execute(GstReturnPeriod $period,FinanceCommandData $command): GstReturnPeriod { return $this->gst->lockReturnPeriod($period,$command->attributes,$command->actor,$command->request); }
}
