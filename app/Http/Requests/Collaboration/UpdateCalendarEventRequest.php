...
class UpdateCalendarEventRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        $this->merge([
            'timezone' => $this->input('timezone') ?: ($this->route('calendarEvent')?->timezone ?? 'Asia/Kolkata'),
    ...
    public function after(): array
    {
        return [
            function (Validator $validator): void {
                ...
                if (! $actor || ! $event instanceof CalendarEvent) {
                    return;
                }
                ...
                if (
                    ...
                    $validator->errors()->add('company_id', 'A company is required when updating a private company-level calendar event as a global user.');
                }
            },
        ];
    }
