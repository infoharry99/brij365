...
class ReraRegistrationIndexRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('viewAny', ReraRegistration::class) === true;
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => ['nullable', 'string', Rule::in(['submitted', 'verified'])],
        ...
        return [
            function (Validator $validator): void {
                app(QueryFilterPolicy::class)->rejectUnexpected(
                    $validator,
                    $this->query(),
                    ['project_id', 'status', 'expires_within_days', 'per_page', 'page'],
                );
