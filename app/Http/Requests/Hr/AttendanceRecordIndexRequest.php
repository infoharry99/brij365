...
class AttendanceRecordIndexRequest extends FormRequest
{
    ...
    {
        return [
            'view' => ['nullable', Rule::in(['records', 'exceptions', 'trace'])],
            'employee_id' => ['nullable', 'integer', 'exists:employees,id'],
            'status' => ['nullable', Rule::in(['present', 'absent', 'late', 'early_leave', 'half_day', 'on_leave', 'weekly_off', 'holiday'])],
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator): void {
            ...
            if (
                ...
                $validator->errors()->add('employee_id', 'You can view attendance records only for your own employee profile.');
            }
        });
    }
}
