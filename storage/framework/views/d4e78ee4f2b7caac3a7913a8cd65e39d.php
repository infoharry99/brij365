        ...
        <?php $__empty_1 = true; $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          ...
          <article class="mac-acct-card">
            ...
            <div class="mac-acct-row">
              ...
              <img src="<?php echo e(route('mailbox.accounts.avatar', $account)); ?>" alt="<?php echo e($account->name); ?>" style="width:40px; height:40px; border-radius:50%; object-fit:cover; border:2px solid var(--ac-border-2); flex-shrink:0;">
              <div class="mac-acct-info">
                ...
                <small style="display:inline-flex; align-items:center; gap:4px;">
                  ...
                  <button type="button" onclick="copyEmailToClipboard('<?php echo e($account->email); ?>', event)" title="Copy email address" style="background:none; border:none; color:#64748B; cursor:pointer; padding:1px 4px; font-size:11px; border-radius:3px;" onmouseover="this.style.color='#F58220'" onmouseout="this.style.color='#64748B'">
              ...
              <div style="display:flex; gap:6px; flex-wrap:wrap; align-items:center;">
                <button type="button" class="mac-btn" onclick="toggleAccountPanel('details-<?php echo e($account->id); ?>')">
                  <i class="fa-solid fa-eye" style="font-size:11px"></i>
                  Show
                </button>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $account)): ?>
                  <button type="button" class="mac-btn" onclick="toggleAccountPanel('edit-<?php echo e($account->id); ?>')">
                    <i class="fa-solid fa-pen-to-square" style="font-size:11px"></i>
                    Edit
                  </button>
                  <button type="button" class="mac-btn" onclick="toggleAccountPanel('password-<?php echo e($account->id); ?>')">
                    <i class="fa-solid fa-key" style="font-size:11px"></i>
                    Change Password
                  </button>
                <?php endif; ?>
                <a class="mac-btn mac-btn-primary" href="<?php echo e(route('mailbox.external.show', $account)); ?>">
            ...
            <div id="details-<?php echo e($account->id); ?>" class="mac-sub-panel" style="display:none; margin-top:14px; padding:16px; background:#F8FAFC; border:1px solid #E2E8F0; border-radius:10px;">
              <h3 style="font-size:13px; font-weight:700; color:#0F172A; margin-bottom:12px; display:flex; align-items:center; justify-content:space-between;">
                ...
                <button type="button" onclick="toggleAccountPanel('details-<?php echo e($account->id); ?>')" style="background:none; border:none; color:#94A3B8; cursor:pointer; font-size:14px;"><i class="fa-solid fa-xmark"></i></button>
              </h3>
              <div style="display:flex; align-items:center; gap:14px; background:#fff; padding:12px 14px; border:1px solid #E2E8F0; border-radius:8px; margin-bottom:12px;">
                <img src="<?php echo e(route('mailbox.accounts.avatar', $account)); ?>" alt="<?php echo e($account->name); ?>" style="width:52px; height:52px; border-radius:50%; object-fit:cover; border:2px solid var(--ac-accent); flex-shrink:0;">
                <div>
                  <h4 style="font-size:14px; font-weight:700; color:#0F172A; margin:0;"><?php echo e($account->name); ?></h4>
              ...
              <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap:12px; font-size:12.5px;">
                <div style="background:#fff; padding:10px 14px; border-radius:6px; border:1px solid #E2E8F0;">
                  ...
                  <div style="font-weight:600; color:#0F172A; margin-top:2px;"><?php echo e($account->name); ?></div>
                </div>
                <div style="background:#fff; padding:10px 14px; border-radius:6px; border:1px solid #E2E8F0;">
                ...
                <div style="background:#fff; padding:10px 14px; border-radius:6px; border:1px solid #E2E8F0;">
                  ...
                  <div style="font-weight:600; color:#0F172A; margin-top:2px;"><?php echo e($account->username); ?></div>
                </div>
                <div style="background:#fff; padding:10px 14px; border-radius:6px; border:1px solid #E2E8F0;">
                  ...
                  <div style="font-weight:600; color:#0F172A; margin-top:2px;"><?php echo e($account->imap_host); ?></div>
                </div>
                <div style="background:#fff; padding:10px 14px; border-radius:6px; border:1px solid #E2E8F0;">
                  ...
                  <div style="font-weight:600; color:#0F172A; margin-top:2px;"><?php echo e($account->smtp_host); ?></div>
                </div>
                <div style="background:#fff; padding:10px 14px; border-radius:6px; border:1px solid #E2E8F0;">
                  <span style="font-size:10.5px; color:#64748B; font-weight:700; text-transform:uppercase; letter-spacing:.05em;">Ports</span>
                  <div style="font-weight:600; color:#0F172A; margin-top:2px;">IMAP: <?php echo e($account->imap_port); ?> &middot; SMTP: <?php echo e($account->smtp_port); ?></div>
                </div>
                <div style="background:#fff; padding:10px 14px; border-radius:6px; border:1px solid #E2E8F0;">
                  <span style="font-size:10.5px; color:#64748B; font-weight:700; text-transform:uppercase; letter-spacing:.05em;">Encryption</span>
                  <div style="font-weight:600; color:#0F172A; margin-top:2px;">IMAP: <?php echo e(strtoupper($account->imap_encryption ?: 'None')); ?> &middot; SMTP: <?php echo e(strtoupper($account->smtp_encryption ?: 'None')); ?></div>
                </div>
              </div>
              <div style="background:#fff; padding:10px 14px; border-radius:6px; border:1px solid #E2E8F0; margin-top:12px;">
                ...
                <div style="font-size:12.5px; color:#334155; margin-top:4px; white-space:pre-wrap;"><?php echo e(($account->settings['signature_text'] ?? null) ?: 'No signature configured.'); ?></div>
              </div>
            </div>

            
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $account)): ?>
              <div id="edit-<?php echo e($account->id); ?>" class="mac-sub-panel" style="display:none; margin-top:14px; padding:16px; background:#F8FAFC; border:1px solid #E2E8F0; border-radius:10px;">
                <h3 style="font-size:13px; font-weight:700; color:#0F172A; margin-bottom:12px; display:flex; align-items:center; justify-content:space-between;">
                  <span><i class="fa-solid fa-pen-to-square" style="color:var(--ac-accent); margin-right:6px;"></i> Edit Email Account</span>
                  <button type="button" onclick="toggleAccountPanel('edit-<?php echo e($account->id); ?>')" style="background:none; border:none; color:#94A3B8; cursor:pointer; font-size:14px;"><i class="fa-solid fa-xmark"></i></button>
                </h3>
                <form method="POST" action="<?php echo e(route('mailbox.accounts.update', $account)); ?>" enctype="multipart/form-data" class="mac-form-grid">
                  <?php echo csrf_field(); ?>
                  ...
                  <div class="mac-form-wide" style="display:flex; align-items:center; gap:14px; background:#fff; padding:12px 14px; border:1px solid #E2E8F0; border-radius:8px;">
                    ...
                    <div style="flex:1;">
                      ...
                      <?php if(! empty($account->settings['avatar_path'])): ?>
                  ...
                  <label class="mac-form-wide">
                    ...
                    <input name="name" required value="<?php echo e(old('name', $account->name)); ?>" placeholder="Sales Mailbox">
                  </label>
                  <label class="mac-form-wide">
                  ...
                  <label class="mac-form-wide">
                    ...
                    <textarea name="signature" rows="4" maxlength="5000" placeholder="Name&#10;Title&#10;Company"><?php echo e(old('signature', $account->settings['signature_text'] ?? '')); ?></textarea>
                  </label>
                  ...
                  <label>
                    Email Address
                    <input value="<?php echo e($account->email); ?>" readonly disabled style="background:#E2E8F0; color:#64748B; cursor:not-allowed;">
                  </label>
                  <label>
                    Username
                    <input value="<?php echo e($account->username); ?>" readonly disabled style="background:#E2E8F0; color:#64748B; cursor:not-allowed;">
                  </label>
                  <label>
                    Incoming Server (IMAP)
                    <input value="<?php echo e($account->imap_host); ?>" readonly disabled style="background:#E2E8F0; color:#64748B; cursor:not-allowed;">
                  </label>
                  <label>
                    IMAP Port & Encryption
                    <input value="<?php echo e($account->imap_port); ?> (<?php echo e(strtoupper($account->imap_encryption ?: 'None')); ?>)" readonly disabled style="background:#E2E8F0; color:#64748B; cursor:not-allowed;">
                  </label>
                  <label>
                    Outgoing Server (SMTP)
                    <input value="<?php echo e($account->smtp_host); ?>" readonly disabled style="background:#E2E8F0; color:#64748B; cursor:not-allowed;">
                  </label>
                  <label>
                    SMTP Port & Encryption
                    <input value="<?php echo e($account->smtp_port); ?> (<?php echo e(strtoupper($account->smtp_encryption ?: 'None')); ?>)" readonly disabled style="background:#E2E8F0; color:#64748B; cursor:not-allowed;">
                  </label>
                  ...
                  <div class="mac-form-actions mac-form-wide" style="padding-top:8px;">
                    ...
                    <button type="button" class="mac-btn" onclick="toggleAccountPanel('edit-<?php echo e($account->id); ?>')">Cancel</button>
                  </div>
                </form>
              </div>

              
              <div id="password-<?php echo e($account->id); ?>" class="mac-sub-panel" style="display:none; margin-top:14px; padding:16px; background:#F8FAFC; border:1px solid #E2E8F0; border-radius:10px;">
                <h3 style="font-size:13px; font-weight:700; color:#0F172A; margin-bottom:12px; display:flex; align-items:center; justify-content:space-between;">
                  <span><i class="fa-solid fa-key" style="color:var(--ac-accent); margin-right:6px;"></i> Change Password</span>
                  <button type="button" onclick="toggleAccountPanel('password-<?php echo e($account->id); ?>')" style="background:none; border:none; color:#94A3B8; cursor:pointer; font-size:14px;"><i class="fa-solid fa-xmark"></i></button>
                </h3>
                <form method="POST" action="<?php echo e(route('mailbox.accounts.change-password', $account)); ?>" class="mac-form-grid">
                  <?php echo csrf_field(); ?>
                  ...
                  <div class="mac-form-actions mac-form-wide" style="padding-top:8px;">
                    ...
                    <button type="button" class="mac-btn" onclick="toggleAccountPanel('password-<?php echo e($account->id); ?>')">Cancel</button>
                  </div>
                </form>
              </div>
            <?php endif; ?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\MailboxAccount::class)): ?>
      <section class="mac-panel">
        ...
        <div style="padding:20px 22px 24px">
          <form method="POST" action="<?php echo e(route('mailbox.accounts.store')); ?>" enctype="multipart/form-data" class="mac-form-grid">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.builder360-classic', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/developer/public_html/build365/resources/views/mailbox/accounts/index.blade.php ENDPATH**/ ?>